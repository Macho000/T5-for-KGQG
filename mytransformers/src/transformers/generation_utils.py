...
class GenerationMixin:
    ...
    def generate(
        ...
        three_dim_attention_mask: Optional[bool] = None,
        **model_kwargs,
        ...
        #     print("generate generation_utils L.882 input_ids.shape",str(input_ids.shape))
        # for arg in model_kwargs:
        #     print("generate generation_utils L.884 arg",str(arg))
        # set init values
        ...
        # if self.config.is_encoder_decoder is not None:
        #     print("generate generation_utils L.927 self.config.is_encoder_decoder",str(self.config.is_encoder_decoder))
        
        encoder_input_ids = input_ids if self.config.is_encoder_decoder else None

        # if encoder_input_ids is not None:
        #     print("generate generation_utils L.927 encoder_input_ids",str(encoder_input_ids.shape))
        ...
        if is_greedy_gen_mode:
            ...
            # greedy search
            # if input_ids is not None:
            #     print("generate generation_utils L.1564 input_ids.shape",str(input_ids.shape))
            # if logits_processor is not None:
            #     print("generate generation_utils L.1565 logits_processor.shape",str(logits_processor))
            # if stopping_criteria is not None:
            #     print("generate generation_utils L.1566 stopping_criteria.shape",str(stopping_criteria))
            # if max_length is not None:
            #     print("generate generation_utils L.1566 max_length",str(max_length))
            # if pad_token_id is not None:
            #     print("generate generation_utils L.1566 pad_token_id.shape",str(pad_token_id))
            # if eos_token_id is not None:
            #     print("generate generation_utils L.1566 eos_token_id",str(eos_token_id))
            # if output_scores is not None:
            #     print("generate generation_utils L.1567 output_scores.shape",str(output_scores))
            # if return_dict_in_generate is not None:
            #     print("generate generation_utils L.1567 return_dict_in_generate",str(return_dict_in_generate))
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            #print("Greedy Search in generation_utils L.1270input_ids",str(input_ids))
            # for arg in model_kwargs:
            #     print("Greedy Search in generation_utils L.1272:", str(arg))
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs)

            # forward pass to get next token
            # for arg in model_inputs:
            #     print("Greedy Search in generation_utils L.1273", arg)
            outputs = self(
                **model_inputs,
                return_dict=True,
